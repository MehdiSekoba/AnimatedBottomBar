 ...
 *
 * ```
 * val style = BottomBarDefaults.style(
 *     containerColor = MaterialTheme.colorScheme.surface,
 *     selectedIconColor = MaterialTheme.colorScheme.primary,
 * )
 * ```
 *
 * All colors default to [Color.Unspecified] in the public factory so that
 * [BottomBarDefaults.style] can resolve them against the current [androidx.compose.material3.MaterialTheme].
 *
 ...
 */
@Immutable
public data class BottomBarStyle internal constructor(
