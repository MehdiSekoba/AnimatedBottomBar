 ...
 *   selection changes. A spring gives the indicator its signature "settle" motion. It is typed as
 *   `AnimationSpec<Float>` because the indicator position is animated as a single normalized value.
 ...
 */
@Immutable
public data class BottomBarAnimationSpec(
